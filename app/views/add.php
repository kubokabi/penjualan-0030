    ...
    <script>
        function previewImage(event) {
            ...
            reader.onload = function(e) {
                ...
                image.style.display = 'block'; // Menampilkan gambar setelah diunggah
            }

            if (file) {
                reader.readAsDataURL(file); // Menggunakan readAsDataURL untuk membaca file
            } else {
                image.src = ""; // Reset src jika tidak ada file
                image.style.display = 'none'; // Menyembunyikan gambar jika tidak ada file
            }
        }
    </script>
</body>
